...
eMBRTUInit( UCHAR ucSlaveAddress, UCHAR ucPort, ULONG ulBaudRate, eMBParity eParity )
{
    ...
    if( xMBPortSerialInit( ucPort, ulBaudRate, 8, eParity ) != 1 )
    {
        eStatus = MB_EPORTERR;
    }
    else
    {
        ...
        if( xMBPortTimersInit( ( USHORT ) usTimerT35_50us ) != 1 )
        {
            eStatus = MB_EPORTERR;
        }
    }
...
{
    BOOL            xFrameReceived = 0;
    eMBErrorCode    eStatus = MB_ENOERR;

    ;
    ((usRcvBufferPos < 256) ? (void)0 : ( __aeabi_assert("usRcvBufferPos < MB_SER_PDU_SIZE_MAX", "C:\\Users\\Administrator\\Desktop\\\261\352\327\274\263\314\320\362\312\325\274\257\\\327\324\274\272\261\352\327\274\277\342\322\306\326\262modbus\263\311\271\246\\modbus\\rtu\\mbrtu.c", 157), ( __iar_EmptyStepPoint())));
        ...
        && ( usMBCRC16( ( UCHAR * ) ucRTUBuf, usRcvBufferPos ) == 0 ) )
    {
        ...
        *pusLength = ( USHORT )( usRcvBufferPos - 1 - 2 );

         
        *pucFrame = ( UCHAR * ) & ucRTUBuf[1];
        xFrameReceived = 1;
    }
    else
    {
...
{
    BOOL            xTaskNeedSwitch = 0;
    UCHAR           ucByte;

    ((eSndState == STATE_TX_IDLE) ? (void)0 : ( __aeabi_assert("eSndState == STATE_TX_IDLE", "C:\\Users\\Administrator\\Desktop\\\261\352\327\274\263\314\320\362\312\325\274\257\\\327\324\274\272\261\352\327\274\277\342\322\306\326\262modbus\263\311\271\246\\modbus\\rtu\\mbrtu.c", 235), ( __iar_EmptyStepPoint())));
...
xMBRTUTransmitFSM( void )
{
    ...
    ((eRcvState == STATE_RX_IDLE) ? (void)0 : ( __aeabi_assert("eRcvState == STATE_RX_IDLE", "C:\\Users\\Administrator\\Desktop\\\261\352\327\274\263\314\320\362\312\325\274\257\\\327\324\274\272\261\352\327\274\277\342\322\306\326\262modbus\263\311\271\246\\modbus\\rtu\\mbrtu.c", 294), ( __iar_EmptyStepPoint())));
...
xMBRTUTimerT35Expired( void )
{
    ...
    default:
        ((( eRcvState == STATE_RX_INIT ) || ( eRcvState == STATE_RX_RCV ) || ( eRcvState == STATE_RX_ERROR )) ? (void)0 : ( __aeabi_assert("( eRcvState == STATE_RX_INIT ) || ( eRcvState == STATE_RX_RCV ) || ( eRcvState == STATE_RX_ERROR )", "C:\\Users\\Administrator\\Desktop\\\261\352\327\274\263\314\320\362\312\325\274\257\\\327\324\274\272\261\352\327\274\277\342\322\306\326\262modbus\263\311\271\246\\modbus\\rtu\\mbrtu.c", 352), ( __iar_EmptyStepPoint())));
    }
