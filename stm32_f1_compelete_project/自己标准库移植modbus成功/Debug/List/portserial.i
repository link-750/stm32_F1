...
xMBPortSerialPutByte( CHAR ucByte )
{
    ...
    USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ucByte);
    return 1;
}
...
xMBPortSerialGetByte( CHAR * pucByte )
{
   ...
   *pucByte = USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
    return 1;
}
...
USART1_IRQHandler(void)
{
  ...
  if (USART_GetITStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0727)) == SET)
    {
