...
static USHORT usRegInputStart = 1;
static USHORT usRegInputBuf[4];
static USHORT usRegHoldingStart = 1;
static USHORT usRegHoldingBuf[4];
static UCHAR ucRegCoilsBuf[16 / 8];
static UCHAR ucRegDiscBuf[16 / 8] =
  { 0, 0 };
...
eMBErrorCode eMBRegCoilsCB(UCHAR * pucRegBuffer, USHORT usAddress, USHORT usNCoils, eMBRegisterMode eMode)
{
  ...
  if ((usAddress >= 1)
      && (usAddress + usNCoils <= 1 + 16))
    {
      usBitOffset = (unsigned short) (usAddress - 1);
      switch (eMode)
        {
