                ...
                UCHAR ucValue )
{
    ...
    ((ucNBits <= 8) ? (void)0 : ( __aeabi_assert("ucNBits <= 8", "C:\\Users\\Administrator\\Desktop\\\261\352\327\274\263\314\320\362\312\325\274\257\\\327\324\274\272\261\352\327\274\277\342\322\306\326\262modbus\263\311\271\246\\modbus\\functions\\mbutils.c", 56), ( __iar_EmptyStepPoint())));
    ((( size_t )8U == sizeof( UCHAR ) * 8) ? (void)0 : ( __aeabi_assert("( size_t )BITS_UCHAR == sizeof( UCHAR ) * 8", "C:\\Users\\Administrator\\Desktop\\\261\352\327\274\263\314\320\362\312\325\274\257\\\327\324\274\272\261\352\327\274\277\342\322\306\326\262modbus\263\311\271\246\\modbus\\functions\\mbutils.c", 57), ( __iar_EmptyStepPoint())));

    
 
    usByteOffset = ( USHORT )( ( usBitOffset ) / 8U );

     
    usNPreBits = ( USHORT )( usBitOffset - usByteOffset * 8U );
    ...
    ucByteBuf[usByteOffset + 1] = ( UCHAR )( usWordBuf >> 8U );
}
